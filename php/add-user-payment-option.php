<?php
    ...
    if ( isset($_POST['add-payment-option']) ) {
        ...
        if ( isset($_POST['payment-method']) && isset($_POST['cardholder-name']) && isset($_POST['card-number']) && isset($_POST['withdrawal-type']) && isset($_POST['account-balance'])) {
            ...
            $sqlQuery = "INSERT INTO payment_account(payment_account_ID, username, cardholder_name, card_number, expiration_date, payment_method, withdrawal_type, balance, status) VALUES (DEFAULT, '$user', '$cardholderName', '$cardNumber', '$expirationDate', '$paymentMethod', '$withdrawalType', '$accountBalance', '$accountStatus')";
