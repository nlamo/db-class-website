<?php
    ...
    require('../php/make-payment-employer.php');
?>
...
<head>
    ...
    <title>Employer Make Payment</title>
</head>
<body>
  ...
  <!-- NOTE: for printing if the account has insufficient funds -->
    ...
    <div class="dashboard-container" style="width: 500px;">
        ...
        <div class="payment-dashboard">
            ...
            <form method="POST" action="" class="employer-make-payment">
    ...
    <br><br><a href="./dashboard-employer-payments.php">Return to Employer Payments</a><br><br>
</body>
</html>