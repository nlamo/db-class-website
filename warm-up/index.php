...
<?php
    ...
    if (isset($_POST['submit-publisher'])) {
        ...
        $sql_query = "INSERT INTO publisher(publisher_id, company_name, branches, telephone_number, address, city, province, postal_code, email, website) VALUES('$publisher_id', '$company_name', '$branch', '$telephone_number', '$address', '$city', '$province', '$postal_code', '$email_address', '$website')";
