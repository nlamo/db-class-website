<?php
    ...
    if ( isset($_POST['add-payment-option']) ) {
        ...
        if ( isset($_POST['payment-method']) && isset($_POST['cardholder-name']) && isset($_POST['card-number']) && isset($_POST['withdrawal-type']) ) {
            ...
            $sqlQuery = "INSERT INTO payment_information(payment_information_ID, username, cardholder_name, card_number, expiration_date, payment_method, withdrawal_type) VALUES (DEFAULT, '$employer', '$cardholderName', '$cardNumber', '$expirationDate', '$paymentMethod', '$withdrawalType')";
