    ...
    if (isset($_POST['edit-payment-option'])) {
        ...
        if (!empty($accountID) || !empty($paymentMethod) || !empty($cardholderName) || !empty($cardNumber) || !empty($withdrawalType) || !empty($accountBalance) )
        {
            ...
            if (!empty($accountID) && !empty($paymentMethod)) {
                $sqlQuery = "UPDATE payment_account SET payment_account.payment_method='$paymentMethod' WHERE payment_account.payment_account_ID='$accountID' AND payment_account.username='$user'";
            ...
            if (!empty($accountID) && !empty($cardholderName)) {
                $sqlQuery = "UPDATE payment_account SET payment_account.cardholder_name='$cardholderName' WHERE payment_account.payment_account_ID='$accountID' AND payment_account.username='$user'";
            ...
            if (!empty($accountID) && !empty($cardNumber)) {
                $sqlQuery = "UPDATE payment_account SET payment_account.card_number='$cardNumber' WHERE payment_account.payment_account_ID='$accountID' AND payment_account.username='$user'";
            ...
            if (!empty($accountID) && !empty($expirationDate)) {
                $sqlQuery = "UPDATE payment_account SET payment_account.expiration_date='$expirationDate' WHERE payment_account.payment_account_ID='$accountID' AND payment_account.username='$user'";
            ...
            if (!empty($accountID) && !empty($withdrawalType)) {
                $sqlQuery = "UPDATE payment_account SET payment_account.withdrawal_type='$withdrawalType' WHERE payment_account.payment_account_ID='$accountID' AND payment_account.username='$user'";
            ...
            if (!empty($accountID) && !empty($accountBalance)) {
                ...
                $sqlQuery = "UPDATE payment_account SET payment_account.balance='$accountBalance' WHERE payment_account.payment_account_ID='$accountID' AND payment_account.username='$user'";
